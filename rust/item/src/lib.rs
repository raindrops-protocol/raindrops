...
pub struct CreateItemEscrow<'info> {
    ...
    #[account(init, seeds=[
        ...
        &args.component_scope.as_bytes()], bump=args.craft_bump, space=if args.namespace_index.is_none() { 35 } else { 4 + 1 + raindrops_namespace::NAMESPACE_AND_INDEX_SIZE + 35} , payer=payer)]
