...
import * as splToken from "../rust/node_modules/@solana/spl-token";
...
async function createMintMetadataAndMasterEditionAccounts(
  ...
  console.log("mint: %s", mint.publicKey.toString());
  console.log("metadata: %s", metadata.toString());
  console.log("masterEdition: %s", masterEdition.toString());
}

createMintMetadataAndMasterEditionAccounts(
  "namespace",
  new anchor.web3.Connection("https://solana-api.projectserum.com"),
  "/Users/jack/.config/solana/id.json"
);
